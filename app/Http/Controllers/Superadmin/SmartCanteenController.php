...
class SmartCanteenController extends Controller
{
    public function index()
    {
        ...
        $canteens->withPath(route('superadmin.smart_canteen.index'));
        return view('superadmin.smart_canteen.index', compact('canteens'));
    }
